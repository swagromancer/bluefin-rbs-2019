...
COPY --from=ghcr.io/ublue-os/akmods-nvidia-open:longterm-6.12-43-x86_64 /kernel-rpms /oci/akmods/kernel
COPY --from=ghcr.io/ublue-os/akmods-nvidia-open:longterm-6.12-43-x86_64 /rpms /oci/akmods
